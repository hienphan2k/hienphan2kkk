 ...
 * @author Hien Phan
 */
public class NhanKhau_QuayVe extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Đăng ký quay về sau tạm vắng");
        ...
        if (txtCmnd.getText().trim().length() != 8
            ...
            try ( Connection connection = MysqlConnection.getMysqlConnection()) {
                String query = "SELECT *  FROM nhankhau LEFT JOIN "
                        ...
                        + "ON nhankhau.id = A.idnhankhau WHERE tinhtrang = 'cập nhật'";
                try ( PreparedStatement preparedStatement = connection.prepareStatement(query)) {
                    ResultSet rs = preparedStatement.executeQuery();

                    while (rs.next()) {
                        if (txtCmnd.getText().trim().equals(rs.getString("cmnd"))) {
                            check = true;
        ...
        if (txtCmnd.getText().trim().length() != 8
            ...
            try ( Connection connection = MysqlConnection.getMysqlConnection()) {
                String query = "SELECT *  FROM nhankhau LEFT JOIN "
                        ...
                        + nhanKhau.getCmnd() + "' ORDER by id DESC LIMIT 1";
                try ( PreparedStatement preparedStatement = connection.prepareStatement(query)) {
                    ResultSet rs = preparedStatement.executeQuery();
