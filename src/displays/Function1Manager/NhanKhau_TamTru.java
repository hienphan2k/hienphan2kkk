 ...
 * @author Hien Phan
 */
public class NhanKhau_TamTru extends javax.swing.JFrame {
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(dateNgaySinh, javax.swing.GroupLayout.DEFAULT_SIZE, 352, Short.MAX_VALUE)
                                .addComponent(txtQuocTich)
                                .addComponent(txtNoiThuongTru)
                                .addComponent(cbGioiTinh, javax.swing.GroupLayout.PREFERRED_SIZE, 81, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(cbGioiTinh, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void btnXacNhanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXacNhanActionPerformed
        if (txtCmnd.getText().trim().length() != 8
            ...
            NhanKhauModel nhanKhau = new NhanKhauModel(txtHoTen.getText().trim(),
                    dateNgaySinh.getDate(), cbGioiTinh.getSelectedItem().toString().trim(), txtQuocTich.getText().trim(),
                    txtCmnd.getText().trim(), txtNoiThuongTru.getText().trim(), txtNoiTamTru.getText().trim(),
                    "tạm trú", dateTuNgay.getDate(), dateDenNgay.getDate(), new Date());

            controller.themNhanKhau(nhanKhau);

            JOptionPane.showMessageDialog(rootPane, "Đăng ký tạm trú thành công!");
            MainFrame.it.setEnabled(true);
            dispose();
